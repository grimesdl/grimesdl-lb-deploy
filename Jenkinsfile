pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/grimesdl/grimesdl-lb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('grimesdl-225')   // <---- Change this to match your kubernetes cluster credentials
    }
